...
- [] Step 6:\
  ...
  **Tip:** You will want to use an array acting as a queue to keep track of all the child nodes that you have yet to traverse and to add new ones to the list.\ [See Level Order Traversal video](#resources)
